...
# source https://gist.githubusercontent.com/AWolf81/421976e65099d3e58a32/raw/f0d0a3b97273b21ee83f6def7181ff2521f67e9c/settings.py
...
class ExtendedSettings(SettingsWithSpinner):
    def __init__(self, *kwargs):
        super(ExtendedSettings,self).__init__(*kwargs)
        self.register_type('colorpicker', SettingColorPicker)
        self.register_type('scrolloptions', SettingScrollOptions)
        # s.add_kivy_panel()
